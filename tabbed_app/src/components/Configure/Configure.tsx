...
export const Configure: React.FC<ConfigureProps> = ({
  ...
  const addDashboard = () => {
    setLocalConfigurationData({
      ...
      defaultFileName: localConfigurationData.defaultFileName
    })
  }
  ...
  const changeDefaultFileName = (event: React.ChangeEvent<HTMLInputElement>) => {
    localConfigurationData.defaultFileName = event.currentTarget.value
    setLocalConfigurationData({ ...localConfigurationData })
  }
    ...
    <div>
      ...
      <Box m="large">
        ...
        >
          ...
          <Divider mt="medium" appearance="onDark" />
          <Heading as="h3">Default Download Filename</Heading>

          <FieldText
          value={localConfigurationData.defaultFileName}
            onChange={changeDefaultFileName}
          />
